      ...
      <main>
          ...
          >
            ...
            <div className="hero-content text-white">
              <div className="text-center max-w-md">
                ...
                <p className="mb-5">
                  กรุณาชำระเงินจองบูธภายใน <strong>วันที่ 15 ก.ค. 2569</strong>
                </p>
                <Link href="/book-booth" className="btn btn-success text-white">จองบูธ</Link>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-5">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Modern Card */}
            <div className="card bg-base-100 shadow-sm overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="grid md:grid-cols-3 gap-0 min-h-[450px]">

                {/* Left Side - Info (1/3 ≈ 33%) */}
                <div className="p-8 flex flex-col justify-between border-r border-base-200">
                  <div>
                ...
                {/* Right Side - Map (2/3 ≈ 67%) */}
                <div className="md:col-span-2 relative min-h-[450px]">
                  <iframe
